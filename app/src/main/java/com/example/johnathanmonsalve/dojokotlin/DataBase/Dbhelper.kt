package com.example.johnathanmonsalve.dojokotlin.DataBase
...
/**
 * Created by johnathan.monsalve on 25/08/18.
 */
...
class Dbhelper(var context: Context) :SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION){
    ...
    fun insertNote(note: Note){
        ...
        if(resultado === -1.toLong()){
            ...
            Toast.makeText(context, "Todo OK bro",Toast.LENGTH_SHORT).show()
        }
